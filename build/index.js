...
class PageComponent extends HTMLElement {
  ...
  connectedCallback() {
    ...
    let startPath = `${createPath("lessons", path === "/" ? "start-page" : location.pathname.slice(1))}`;
