      ...
      for ( let lesson of this.menuData ) {
          ...
          for ( let item of lesson.items ) {
              ...
              anchor.onclick = function ( event ) {
                  ...
                  else window.history.pushState( { route: `#${event.target.href}` }, event.target.innerText, `#${event.target.href}` );
