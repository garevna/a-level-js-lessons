...
| <img src="https://garevna.github.io/a-level-js-lessons/src/images/lessons/smoke-monkey.gif" width="200"/> | ![ico-25 yes] Уважаемые дамы и господа<br>Курение вредит вашему здоровью,<br>а курение конкретно в этом подъезде может вообще резко подорвать его |
...
| ^^можно ли получить наследство от _класса_ "дедушка" ?^^ | <img src="https://garevna.github.io/a-level-js-lessons/src/images/lessons/cat-no.gif" width="150"/> | ^^Даже кошке понятно, что только **конкретный** дедушка может оставить вам наследство^^ |
