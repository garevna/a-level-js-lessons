...
Функция **`testFile`** должна проверять, является ли выбранный файл изображением, и если нет - генерировать исключение с текстом "Выбранный файл не является изображением"
