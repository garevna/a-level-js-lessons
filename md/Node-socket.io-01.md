# <img src="https://avatars2.githubusercontent.com/u/19735284?s=40&v=4" width="30" title="Ⓒ Irina Fylyppova ( garevna ) 2019"/> socket.io

Используем **`express`**

С помощью **`express`** создаем объект приложения класса **`EventEmitter`**
...
Мы можем запустить сервер с помощью **`http`**
...
Однако **`express`** может создать сервер и без использования **`http`**

Для этого достаточно воспользоваться методом **_`listen`_** приложения **`express`**
