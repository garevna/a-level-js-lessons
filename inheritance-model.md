...
Однако разработчик JS **_Brendan Eich_** хотел, чтобы язык был похож на **Java** с его классической моделью наследования

В результате в JS появляется ключевое слово **`new`**, лишенное практического смысла в языках с прототипной моделью наследования и создающее иллюзию наличия классов
...
Теперь разберемся, зачем нам вообще нужно ключевое слово **`new`**

#### :coffee: 2

Для этого нужен конструктор
