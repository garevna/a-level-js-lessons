...
<table><tr><td>:coffee:</td><td>

На мой взгляд, это вполне соотносится с реальностью:<br/>

можно ли получить наследство от класса "дедушка" ? <img src="https://github.com/garevna/js-course/blob/master/images/lessons/cat-no.gif?raw=true" width="100"/>
<br/><br/>
