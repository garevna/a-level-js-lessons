...
Но на самом деле все, что произошло - это помещение ссылки на объект **`prototype`** функции **`Sigma`** в свойство **_`__proto__`_** объекта **`obj`**
...
## :mortar_board: Наследование, или цепочка прототипов
...
Последним "звеном" в цепочке прототипов будет **`Object`** - "Адам" всех объектов
